        ...
        <div class="container relative z-10 sm:px-10">
            <div class="block grid-cols-2 gap-4 xl:grid">
                ...
                <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
                    ...
                    <h1 class="intro-y mt-10 text-lg font-medium">Información del pago para el evento al que quieres asistir:</h1>
                    <div class="mx-auto my-auto w-full rounded-md bg-white px-5 py-8 shadow-md dark:bg-darkmode-600 sm:w-3/4 sm:px-8 lg:w-2/4 xl:ml-20 xl:w-auto xl:bg-transparent xl:p-0 xl:shadow-none">
                        ...
                        <h3 class="text-lg font-medium mt-5">Datos para el pago:</h3>

                        <div class="mt-5">
                            <div class="box p-5">
                                <p><strong>Banco:</strong> BANCO EJEMPLO </p>
                                <p><strong>Numero Cuenta:</strong> {NUMERO EJEMPLO}</p>
                                <div class="mt-2">
